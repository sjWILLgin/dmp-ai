...
import { inferLayerByName } from '../utils/assetLayer'
import type { AssetCategory } from '../types/models'
import type { AssetLayer } from '../utils/assetLayer'
...
export type DiscoveredTable = {
  ...
  // 资产层级（ODS/DWD/DWS/ADS/MDM/DIM/OTHER）
  layer?: AssetLayer
